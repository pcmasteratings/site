...
abstract class UserAttributes implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\UserAttributesTableMap';
    ...
    /**
     * Initializes internal state of Base\UserAttributes object.
     */
    ...
    /**
     * Compares this with another <code>UserAttributes</code> instance.  If
     * <code>obj</code> is an instance of <code>UserAttributes</code>, delegates to
     * <code>equals(UserAttributes)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|UserAttributes The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[UserAttributesTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[UserAttributesTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UserAttributesTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UserAttributesTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = UserAttributesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\UserAttributes'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildUserAttributesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see UserAttributes::setDeleted()
     * @see UserAttributes::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildUserAttributesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UserAttributesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserAttributesTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(UserAttributesTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }

        $sql = sprintf(
            'INSERT INTO user_attributes (%s) VALUES (%s)',
    ...
    {
        $pos = UserAttributesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['UserAttributes'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UserAttributes'][$this->hashCode()] = true;
        $keys = UserAttributesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserAttributesTableMap::COL_ID)) {
            $criteria->add(UserAttributesTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(UserAttributesTableMap::COL_NAME)) {
            $criteria->add(UserAttributesTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildUserAttributesQuery::create();
        $criteria->add(UserAttributesTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \UserAttributes (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \UserAttributes Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildUserAttributes is new, it will return
    ...
    public function setUserAttributeValuess(Collection $userAttributeValuess, ConnectionInterface $con = null)
    {
        ...
        foreach ($userAttributeValuessToDelete as $userAttributeValuesRemoved) {
            $userAttributeValuesRemoved->setUserAttributes(null);
        }
     ...
     * Otherwise if this UserAttributes is new, it will return
     * an empty collection; or if this UserAttributes has previously
     * been saved, it will retrieve related UserAttributeValuess from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in UserAttributes.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildUserAttributeValues[] List of ChildUserAttributeValues objects
     */
    public function getUserAttributeValuessJoinUser(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildUserAttributeValuesQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(UserAttributesTableMap::DEFAULT_STRING_FORMAT);
    }
