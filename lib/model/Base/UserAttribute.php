...
/**
 * Base class that represents a row from the 'user_attribute' table.
 *
 * 
 *
* @package    propel.generator..Base
*/
abstract class UserAttribute implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\UserAttributeTableMap';
    ...
    /**
     * Initializes internal state of Base\UserAttribute object.
     */
    ...
    /**
     * Compares this with another <code>UserAttribute</code> instance.  If
     * <code>obj</code> is an instance of <code>UserAttribute</code>, delegates to
     * <code>equals(UserAttribute)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|UserAttribute The current object, for fluid interface
     */
     ...
     * @return $this|\UserAttribute The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[UserAttributeTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[UserAttributeTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UserAttributeTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UserAttributeTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = UserAttributeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\UserAttribute'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildUserAttributeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see UserAttribute::setDeleted()
     * @see UserAttribute::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildUserAttributeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UserAttributeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[UserAttributeTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . UserAttributeTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(UserAttributeTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(UserAttributeTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }

        $sql = sprintf(
            'INSERT INTO user_attribute (%s) VALUES (%s)',
    ...
    {
        $pos = UserAttributeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['UserAttribute'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UserAttribute'][$this->hashCode()] = true;
        $keys = UserAttributeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
    ...
    {
        $criteria = new Criteria(UserAttributeTableMap::DATABASE_NAME);

        if ($this->isColumnModified(UserAttributeTableMap::COL_ID)) {
            $criteria->add(UserAttributeTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(UserAttributeTableMap::COL_NAME)) {
            $criteria->add(UserAttributeTableMap::COL_NAME, $this->name);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \UserAttribute (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \UserAttribute Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildUserAttribute is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildUserAttribute The current object (for fluent API support)
     */
    public function setUserAttributeValues(Collection $userAttributeValues, ConnectionInterface $con = null)
    {
        ...
        foreach ($userAttributeValuesToDelete as $userAttributeValueRemoved) {
            $userAttributeValueRemoved->setUserAttribute(null);
        }
    ...
    public function removeUserAttributeValue(ChildUserAttributeValue $userAttributeValue)
    {
        if ($this->getUserAttributeValues()->contains($userAttributeValue)) {
            ...
            $userAttributeValue->setUserAttribute(null);
        }
     ...
     * Otherwise if this UserAttribute is new, it will return
     * an empty collection; or if this UserAttribute has previously
     * been saved, it will retrieve related UserAttributeValues from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in UserAttribute.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildUserAttributeValue[] List of ChildUserAttributeValue objects
     */
    public function getUserAttributeValuesJoinUser(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildUserAttributeValueQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(UserAttributeTableMap::DEFAULT_STRING_FORMAT);
    }
