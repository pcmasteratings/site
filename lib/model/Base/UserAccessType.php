...
/**
 * Base class that represents a row from the 'user_access_type' table.
 *
 * 
 *
* @package    propel.generator..Base
*/
abstract class UserAccessType implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\UserAccessTypeTableMap';
    ...
    /**
     * Initializes internal state of Base\UserAccessType object.
     */
    ...
    /**
     * Compares this with another <code>UserAccessType</code> instance.  If
     * <code>obj</code> is an instance of <code>UserAccessType</code>, delegates to
     * <code>equals(UserAccessType)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|UserAccessType The current object, for fluid interface
     */
     ...
     * @return $this|\UserAccessType The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[UserAccessTypeTableMap::COL_ID] = true;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[UserAccessTypeTableMap::COL_TYPE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UserAccessTypeTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UserAccessTypeTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = UserAccessTypeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\UserAccessType'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildUserAccessTypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see UserAccessType::setDeleted()
     * @see UserAccessType::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildUserAccessTypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UserAccessTypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserAccessTypeTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(UserAccessTypeTableMap::COL_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'type';
        }

        $sql = sprintf(
            'INSERT INTO user_access_type (%s) VALUES (%s)',
    ...
    {
        $pos = UserAccessTypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['UserAccessType'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UserAccessType'][$this->hashCode()] = true;
        $keys = UserAccessTypeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getType(),
        );
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserAccessTypeTableMap::COL_ID)) {
            $criteria->add(UserAccessTypeTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(UserAccessTypeTableMap::COL_TYPE)) {
            $criteria->add(UserAccessTypeTableMap::COL_TYPE, $this->type);
        }
    ...
    {
        $criteria = ChildUserAccessTypeQuery::create();
        $criteria->add(UserAccessTypeTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \UserAccessType (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \UserAccessType Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildUserAccessType is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildUserAccessType The current object (for fluent API support)
     */
    public function setUserAccesses(Collection $userAccesses, ConnectionInterface $con = null)
    {
        ...
        foreach ($userAccessesToDelete as $userAccessRemoved) {
            $userAccessRemoved->setUserAccessType(null);
        }
    ...
    protected function doAddUserAccess(ChildUserAccess $userAccess)
    {
        ...
        $userAccess->setUserAccessType($this);
    }
    ...
    public function removeUserAccess(ChildUserAccess $userAccess)
    {
        if ($this->getUserAccesses()->contains($userAccess)) {
            ...
            $userAccess->setUserAccessType(null);
        }
     ...
     * Otherwise if this UserAccessType is new, it will return
     * an empty collection; or if this UserAccessType has previously
     * been saved, it will retrieve related UserAccesses from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in UserAccessType.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildUserAccess[] List of ChildUserAccess objects
     */
    public function getUserAccessesJoinUser(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildUserAccessQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(UserAccessTypeTableMap::DEFAULT_STRING_FORMAT);
    }
