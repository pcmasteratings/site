...
abstract class RigAttributes implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\RigAttributesTableMap';
    ...
    /**
     * Initializes internal state of Base\RigAttributes object.
     */
    ...
    /**
     * Compares this with another <code>RigAttributes</code> instance.  If
     * <code>obj</code> is an instance of <code>RigAttributes</code>, delegates to
     * <code>equals(RigAttributes)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|RigAttributes The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[RigAttributesTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[RigAttributesTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : RigAttributesTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : RigAttributesTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = RigAttributesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\RigAttributes'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildRigAttributesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see RigAttributes::setDeleted()
     * @see RigAttributes::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildRigAttributesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RigAttributesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(RigAttributesTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(RigAttributesTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }

        $sql = sprintf(
            'INSERT INTO rig_attributes (%s) VALUES (%s)',
    ...
    {
        $pos = RigAttributesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['RigAttributes'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RigAttributes'][$this->hashCode()] = true;
        $keys = RigAttributesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RigAttributesTableMap::COL_ID)) {
            $criteria->add(RigAttributesTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(RigAttributesTableMap::COL_NAME)) {
            $criteria->add(RigAttributesTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildRigAttributesQuery::create();
        $criteria->add(RigAttributesTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \RigAttributes (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \RigAttributes Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildRigAttributes is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildRigAttributes The current object (for fluent API support)
     */
    public function setRigAttributeValuess(Collection $rigAttributeValuess, ConnectionInterface $con = null)
    {
        ...
        foreach ($rigAttributeValuessToDelete as $rigAttributeValuesRemoved) {
            $rigAttributeValuesRemoved->setRigAttributes(null);
        }
    ...
    protected function doAddRigAttributeValues(ChildRigAttributeValues $rigAttributeValues)
    {
        ...
        $rigAttributeValues->setRigAttributes($this);
    }
    ...
    public function removeRigAttributeValues(ChildRigAttributeValues $rigAttributeValues)
    {
        if ($this->getRigAttributeValuess()->contains($rigAttributeValues)) {
            ...
            $rigAttributeValues->setRigAttributes(null);
        }
     ...
     * Otherwise if this RigAttributes is new, it will return
     * an empty collection; or if this RigAttributes has previously
     * been saved, it will retrieve related RigAttributeValuess from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in RigAttributes.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildRigAttributeValues[] List of ChildRigAttributeValues objects
     */
    public function getRigAttributeValuessJoinRigs(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildRigAttributeValuesQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(RigAttributesTableMap::DEFAULT_STRING_FORMAT);
    }
