...
abstract class News implements ActiveRecordInterface 
{
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[NewsTableMap::COL_TEXT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : NewsTableMap::translateFieldName('Text', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(NewsTableMap::COL_TEXT)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NewsTableMap::COL_TEXT)) {
            $criteria->add(NewsTableMap::COL_TEXT, $this->text);
        }
        if ($this->isColumnModified(NewsTableMap::COL_TAGS)) {
