...
abstract class GameLinks implements ActiveRecordInterface 
{
    ...
    /**
     * The value for the game_link_type_id field.
     * @var        string
     */
    protected $game_link_type_id;
    ...
    /**
     * Get the [game_link_type_id] column value.
     * 
     * @return string
     */
    public function getGameLinkTypeId()
    {
        return $this->game_link_type_id;
    }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'game_id':                        
                        ...
                        break;
                    case 'game_link_type_id':                        
                        $stmt->bindValue($identifier, $this->game_link_type_id, PDO::PARAM_INT);
                        break;
                    case 'value':                        
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setGameLinkTypeId($arr[$keys[2]]);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setGameLinkTypeId($this->getGameLinkTypeId());
