 ...
 *
 * @method     ChildRatingsQuery leftJoinUserReviews($relationAlias = null) Adds a LEFT JOIN clause to the query using the UserReviews relation
 * @method     ChildRatingsQuery rightJoinUserReviews($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UserReviews relation
 * @method     ChildRatingsQuery innerJoinUserReviews($relationAlias = null) Adds a INNER JOIN clause to the query using the UserReviews relation
 *
 * @method     \UserReviewsQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class RatingsQuery extends ModelCriteria
{
    ...
    public function filterByUserReviews($userReviews, $comparison = null)
    {
        if ($userReviews instanceof \UserReviews) {
            return $this
                ->addUsingAlias(RatingsTableMap::COL_ID, $userReviews->getRating(), $comparison);
