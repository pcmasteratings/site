...
class GamesTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Description', 'PublisherId', 'DeveloperId', 'Port', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'description', 'publisherId', 'developerId', 'port', ),
        self::TYPE_COLNAME       => array(GamesTableMap::COL_ID, GamesTableMap::COL_TITLE, GamesTableMap::COL_DESCRIPTION, GamesTableMap::COL_PUBLISHER_ID, GamesTableMap::COL_DEVELOPER_ID, GamesTableMap::COL_PORT, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'description', 'publisher_id', 'developer_id', 'port', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Description' => 2, 'PublisherId' => 3, 'DeveloperId' => 4, 'Port' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'description' => 2, 'publisherId' => 3, 'developerId' => 4, 'port' => 5, ),
        self::TYPE_COLNAME       => array(GamesTableMap::COL_ID => 0, GamesTableMap::COL_TITLE => 1, GamesTableMap::COL_DESCRIPTION => 2, GamesTableMap::COL_PUBLISHER_ID => 3, GamesTableMap::COL_DEVELOPER_ID => 4, GamesTableMap::COL_PORT => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'description' => 2, 'publisher_id' => 3, 'developer_id' => 4, 'port' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    {
        $this->addRelation('CompaniesRelatedByDeveloperId', '\\Companies', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':developer_id',
    1 => ':id',
        ...
        $this->addRelation('CompaniesRelatedByPublisherId', '\\Companies', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
